...
---
*/
#ifndef TEST_NAMEDNODE_H
#define TEST_NAMEDNODE_H
#include <stdlib.h>
#include <string.h>
...
/*test_namednode_create.c functions*/
/**
* @brief
...
/*test_namednode_copy.c functions*/
/**
* @brief
* Tests that when the first parameter is NULL the ret is -1
*
...
*
* @return 0 on rdt_namednode_copy failure (bad return)
* @return -1 on rdt_node_get_data failure (null pointer)
* @return -2 on compare copy with original (compare function not 0)
* @return -3 on compare names failure (names NULL)
* @return -4 on compare names failure (names not the same)
* @return 1 on test success
*/
