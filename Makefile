...
pkgdatadir = $(datadir)/librdt
pkgincludedir = $(includedir)/librdt
pkglibdir = $(libdir)/librdt
pkglibexecdir = $(libexecdir)/librdt
...
DIST_COMMON = $(srcdir)/Makefile.am $(top_srcdir)/configure \
	$(am__configure_deps) $(custominclude_HEADERS) \
	$(am__DIST_COMMON)
...
am__installdirs = "$(DESTDIR)$(customincludedir)"
HEADERS = $(custominclude_HEADERS)
...
ACLOCAL = ${SHELL} /home/lorddds/Documentos/PROYECTOS/LibRDT/librdt/missing aclocal-1.15
AMTAR = $${TAR-tar}
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/lorddds/Documentos/PROYECTOS/LibRDT/librdt/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = librdt
...
abs_top_srcdir = /home/lorddds/Documentos/PROYECTOS/LibRDT/librdt
ac_ct_AR = ar
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/lorddds/Documentos/PROYECTOS/LibRDT/librdt/install-sh
...
install-customincludeHEADERS: $(custominclude_HEADERS)
	@$(NORMAL_INSTALL)
	@list='$(custominclude_HEADERS)'; test -n "$(customincludedir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(customincludedir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(customincludedir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_HEADER) $$files '$(DESTDIR)$(customincludedir)'"; \
	  $(INSTALL_HEADER) $$files "$(DESTDIR)$(customincludedir)" || exit $$?; \
	done

uninstall-customincludeHEADERS:
	@$(NORMAL_UNINSTALL)
	@list='$(custominclude_HEADERS)'; test -n "$(customincludedir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(customincludedir)'; $(am__uninstall_files_from_dir)
...
recheck: all 
	...
	$(MAKE) $(AM_MAKEFLAGS) $(TEST_SUITE_LOG) \
	        ...
	        TEST_LOGS="$$log_list"; \
	exit $$?
test/node/test_node_launcher.log: test/node/test_node_launcher
	@p='test/node/test_node_launcher'; \
	b='test/node/test_node_launcher'; \
	$(am__check_pre) $(LOG_DRIVER) --test-name "$$f" \
	--log-file $$b.log --trs-file $$b.trs \
	$(am__common_driver_flags) $(AM_LOG_DRIVER_FLAGS) $(LOG_DRIVER_FLAGS) -- $(LOG_COMPILE) \
	"$$tst" $(AM_TESTS_FD_REDIRECT)
test/bintree/test_bintree_launcher.log: test/bintree/test_bintree_launcher
	@p='test/bintree/test_bintree_launcher'; \
	b='test/bintree/test_bintree_launcher'; \
	$(am__check_pre) $(LOG_DRIVER) --test-name "$$f" \
	--log-file $$b.log --trs-file $$b.trs \
	$(am__common_driver_flags) $(AM_LOG_DRIVER_FLAGS) $(LOG_DRIVER_FLAGS) -- $(LOG_COMPILE) \
	"$$tst" $(AM_TESTS_FD_REDIRECT)
...
installdirs-am:
	for dir in "$(DESTDIR)$(customincludedir)"; do \
...
install-data-am: install-customincludeHEADERS
...
uninstall-am: uninstall-customincludeHEADERS
...
.PHONY: $(am__recursive_targets) CTAGS GTAGS TAGS all all-am \
	...
	install install-am install-customincludeHEADERS install-data \
